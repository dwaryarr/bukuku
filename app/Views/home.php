...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-3 fw-bold text-uppercase">Discover Your Next Great Read</h1>
            <p class="lead fw-normal text-white-75 mb-4">Explore the latest books and find your perfect story</p>
        </div>
    </div>
</header>
